...
function TossupCard({ tossup, highlightedTossup, showCardFooter }) {
    ...
    return (React.createElement("div", { className: "card my-2" },
        React.createElement("div", { className: "card-header d-flex justify-content-between" },
            React.createElement("b", { className: "clickable", onClick: clickToCopy },
                tossup.set.name,
                " | ",
                tossup.category,
                " | ",
                ...
                " | ",
                tossup.difficulty),
            React.createElement("b", { className: "clickable", "data-bs-toggle": "collapse", "data-bs-target": `#question-${_id}` },
                "Packet ",
        ...
        React.createElement("div", { className: "card-container collapse show", id: `question-${_id}` },
            ...
            React.createElement("div", { className: `card-footer ${!showCardFooter && 'd-none'}`, onClick: showTossupStats, "data-bs-toggle": "modal", "data-bs-target": "#tossup-stats-modal" },
                ...
                React.createElement("small", { className: "text-muted float-end" },
                    React.createElement("a", { href: "#", onClick: onClick, id: `report-question-${_id}`, "data-bs-toggle": "modal", "data-bs-target": "#report-question-modal" }, "Report Question"))))));
}
function BonusCard({ bonus, highlightedBonus, showCardFooter }) {
    ...
    return (React.createElement("div", { className: "card my-2" },
        ...
        React.createElement("div", { className: "card-container collapse show", id: `question-${_id}` },
            React.createElement("div", { className: "card-body" },
                React.createElement("p", { dangerouslySetInnerHTML: { __html: highlightedBonus.leadin } }),
                indices.map((i) => React.createElement("div", { key: `${bonus._id}-${i}` },
                    ...
                    React.createElement("p", null,
                        React.createElement("span", null,
                            ...
                            " "),
                        React.createElement("span", { dangerouslySetInnerHTML: { __html: highlightedBonus.parts[i] } })),
                    React.createElement("div", null,
                        React.createElement("b", null, "ANSWER: "),
                        React.createElement("span", { dangerouslySetInnerHTML: { __html: (highlightedBonus?.formatted_answers ?? highlightedBonus.answers)[i] } }))))),
            React.createElement("div", { className: `card-footer ${!showCardFooter && 'd-none'}`, onClick: showBonusStats, "data-bs-toggle": "modal", "data-bs-target": "#bonus-stats-modal" },
                React.createElement("small", { className: "text-muted" }, packetName ? 'Packet ' + packetName : React.createElement("span", null, "\u00A0")),
                React.createElement("small", { className: "text-muted float-end" },
                    React.createElement("a", { href: "#", onClick: onClick, id: `report-question-${_id}`, "data-bs-toggle": "modal", "data-bs-target": "#report-question-modal" }, "Report Question"))))));
}
...
function CategoryButton({ category, color }) {
    ...
    return (React.createElement("div", null,
        React.createElement("input", { type: "checkbox", className: "btn-check", autoComplete: "off", id: category, onClick: handleClick }),
        React.createElement("label", { className: `btn btn-outline-${color} w-100 rounded-0 my-1`, htmlFor: category },
            category,
...
function SubcategoryButton({ subcategory, color, hidden = false }) {
    ...
    return (React.createElement("div", null,
        React.createElement("input", { type: "checkbox", className: "btn-check", autoComplete: "off", id: subcategory, onClick: handleClick }),
        React.createElement("label", { className: `btn btn-outline-${color} w-100 rounded-0 my-1 ${hidden && 'd-none'}`, htmlFor: subcategory },
            subcategory,
            React.createElement("br", null))));
}
function CategoryModal() {
    return (React.createElement("div", { className: "modal", id: "category-modal", tabIndex: "-1" },
        React.createElement("div", { className: "modal-dialog modal-dialog-scrollable" },
            React.createElement("div", { className: "modal-content" },
                React.createElement("div", { className: "modal-header" },
                    React.createElement("h5", { className: "modal-title" }, "Select Categories and Subcategories"),
                    React.createElement("button", { type: "button", className: "btn-close", "data-bs-dismiss": "modal", "aria-label": "Close" })),
                React.createElement("div", { className: "modal-body" },
                    React.createElement("div", { className: "row" },
                        React.createElement("div", { className: "col-6", id: "categories" },
                            React.createElement("h5", { className: "text-center" }, "Categories"),
                            CATEGORY_BUTTONS.map((element) => React.createElement(CategoryButton, { key: element[0], category: element[0], color: element[1] }))),
                        React.createElement("div", { className: "col-6", id: "subcategories" },
                            React.createElement("h5", { className: "text-center" }, "Subcategories"),
                            React.createElement("div", { className: "text-muted text-center", id: "subcategory-info-text" }, "You must select categories before you can select subcategories."),
                            SUBCATEGORY_BUTTONS.map((element) => React.createElement(SubcategoryButton, { key: element[0], subcategory: element[0], color: element[1], hidden: true })))))))));
}
function QueryForm() {
    ...
    for (let i = 0; i < highlightedTossups.length; i++) {
        tossupCards.push(React.createElement(TossupCard, { key: i, tossup: tossups[i], highlightedTossup: highlightedTossups[i], showCardFooter: showCardFooters }));
    }
    const bonusCards = [];
    for (let i = 0; i < highlightedBonuses.length; i++) {
        bonusCards.push(React.createElement(BonusCard, { key: i, bonus: bonuses[i], highlightedBonus: highlightedBonuses[i], showCardFooter: showCardFooters }));
    }
    React.useEffect(() => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("form", { className: "mt-3", onSubmit: event => { handleSubmit(event); } },
            React.createElement("div", { className: "input-group mb-2" },
                React.createElement("input", { type: "text", className: "form-control", id: "query", placeholder: "Query", value: queryString, onChange: event => { setQueryString(event.target.value); } }),
                React.createElement("button", { type: "submit", className: "btn btn-info" }, "Search"),
                React.createElement("button", { id: "randomize", className: "btn btn-success", onClick: event => { handleSubmit(event, true); } }, "Random")),
            React.createElement("div", { className: "row" },
                React.createElement("div", { className: "col-6 col-xl-3 mb-2" },
                    React.createElement("div", { className: "dropdown-checklist btn-group w-100" },
                        React.createElement("button", { className: "btn btn-default text-start w-100", id: "dropdownMenu1", "data-bs-toggle": "dropdown", type: "button", "aria-expanded": "true", "aria-haspopup": "true" }, "Difficulties"),
                        React.createElement("button", { className: "btn btn-default dropdown-toggle dropdown-toggle-split", type: "button" }),
                        React.createElement("ul", { className: "dropdown-menu checkbox-menu allow-focus", id: "difficulties", "aria-labelledby": "dropdownMenu1" },
                            ...
                            React.createElement("li", null,
                                React.createElement("label", null,
                                    React.createElement("input", { type: "checkbox", value: "2" }),
                                    " 2: Easy High School")),
                            React.createElement("li", null,
                                React.createElement("label", null,
                                    React.createElement("input", { type: "checkbox", value: "3" }),
                                    " 3: Regular High School")),
                            React.createElement("li", null,
                                React.createElement("label", null,
                                    React.createElement("input", { type: "checkbox", value: "4" }),
                                    " 4: Hard High School")),
                            React.createElement("li", null,
                                React.createElement("label", null,
                            ...
                            React.createElement("li", null,
                                React.createElement("label", null,
                                    React.createElement("input", { type: "checkbox", value: "6" }),
                                    " 6: \u25CF / Easy College")),
                            React.createElement("li", null,
                                React.createElement("label", null,
                                    React.createElement("input", { type: "checkbox", value: "7" }),
                                    " 7: \u25CF\u25CF / Medium College")),
                            React.createElement("li", null,
                                React.createElement("label", null,
                                    React.createElement("input", { type: "checkbox", value: "8" }),
                                    " 8: \u25CF\u25CF\u25CF / Regionals College")),
                            React.createElement("li", null,
                                React.createElement("label", null,
                            ...
                            React.createElement("li", null,
                                React.createElement("label", null,
                                    ...
                                    " 10: Open"))))),
                React.createElement("div", { className: "col-6 col-xl-3 mb-2" },
                    React.createElement("input", { type: "number", className: "form-control", id: "max-return-length", placeholder: "# to Display", value: maxReturnLength, onChange: event => { setMaxReturnLength(event.target.value); } })),
                React.createElement("div", { className: "input-group col-12 col-xl-6 mb-2" },
                    ...
                    React.createElement("button", { type: "button", className: "btn btn-danger", id: "category-select-button", "data-bs-toggle": "modal", "data-bs-target": "#category-modal" }, "Categories"))),
            React.createElement("div", { className: "row" },
                React.createElement("div", { className: "col-6 col-md-3 mb-2" },
                    React.createElement("select", { className: "form-select", id: "search-type", value: searchType, onChange: event => { setSearchType(event.target.value); } },
                        React.createElement("option", { value: "all" }, "All text"),
                        React.createElement("option", { value: "question" }, "Question"),
                        React.createElement("option", { value: "answer" }, "Answer"))),
                React.createElement("div", { className: "col-6 col-md-3 mb-2" },
                    React.createElement("select", { className: "form-select", id: "question-type", value: questionType, onChange: event => { setQuestionType(event.target.value); } },
                        React.createElement("option", { value: "all" }, "All questions"),
                        React.createElement("option", { value: "tossup" }, "Tossups"),
                        React.createElement("option", { value: "bonus" }, "Bonuses"))),
                React.createElement("div", { className: "col-6 col-md-3 mb-2" },
                    React.createElement("input", { type: "number", className: "form-control", id: "min-year", placeholder: "Min Year", value: minYear, onChange: event => { setMinYear(event.target.value); } })),
                React.createElement("div", { className: "col-6 col-md-3 mb-2" },
                    React.createElement("input", { type: "number", className: "form-control", id: "max-year", placeholder: "Max Year", value: maxYear, onChange: event => { setMaxYear(event.target.value); } }))),
            React.createElement("div", { className: "row" },
                React.createElement("div", { className: "col-12" },
                    React.createElement("div", { className: "form-check form-switch" },
                        React.createElement("input", { className: "form-check-input", type: "checkbox", role: "switch", id: "toggle-regex", checked: regex, onChange: () => { setRegex(!regex); } }),
                        React.createElement("label", { className: "form-check-label", htmlFor: "toggle-regex" }, "Search using regular expression"),
                        React.createElement("a", { href: "https://www.sitepoint.com/learn-regex/" }, " What's this?")),
                    React.createElement("div", { className: "form-check form-switch" },
                        React.createElement("input", { className: "form-check-input", type: "checkbox", role: "switch", id: "toggle-ignore-diacritics", checked: !regex && diacritics, disabled: regex, onChange: () => { setDiacritics(!diacritics); } }),
                        React.createElement("label", { className: "form-check-label", htmlFor: "toggle-ignore-diacritics" }, "Ignore diacritics (May slow down search)")),
                    React.createElement("div", { className: "form-check form-switch" },
                        React.createElement("input", { className: "form-check-input", type: "checkbox", role: "switch", id: "toggle-exact-phrase", checked: !regex && exactPhrase, disabled: regex, onChange: () => { setExactPhrase(!exactPhrase); } }),
                        React.createElement("label", { className: "form-check-label", htmlFor: "toggle-exact-phrase" }, "Search for exact phrase")),
                    React.createElement("div", { className: "form-check form-switch" },
                        React.createElement("input", { className: "form-check-input", type: "checkbox", role: "switch", id: "toggle-powermark-only", checked: powermarkOnly, onChange: () => { setPowermarkOnly(!powermarkOnly); } }),
                        React.createElement("label", { className: "form-check-label", htmlFor: "toggle-powermark-only" }, "Powermarked tossups only")),
                    React.createElement("div", { className: "form-check form-switch" },
                        React.createElement("input", { className: "form-check-input", type: "checkbox", role: "switch", id: "toggle-show-card-footers", checked: showCardFooters, onChange: () => { setShowCardFooters(!showCardFooters); } }),
                        React.createElement("label", { className: "form-check-label", htmlFor: "toggle-show-card-footers" }, "Show card footers")),
                    React.createElement("div", { className: "float-end" },
                        React.createElement("b", null, "Download:"),
                        React.createElement("a", { className: "ms-2 clickable", onClick: () => { downloadQuestionsAsText(tossups, bonuses); } }, "TXT"),
                        React.createElement("a", { className: "ms-2 clickable", onClick: () => { downloadTossupsAsCSV(tossups); downloadBonusesAsCSV(bonuses); } }, "CSV"),
                        React.createElement("a", { className: "ms-2 clickable", onClick: () => { downloadQuestionsAsJSON(tossups, bonuses); } }, "JSON"))))),
        currentlySearching && React.createElement("div", { className: "d-block mx-auto mt-3 spinner-border", role: "status" },
            React.createElement("span", { className: "d-none" }, "Loading...")),
        React.createElement("div", { className: "row text-center mt-2 mt-sm-0" },
        ...
        tossupCount > 0
            ? React.createElement("div", { className: "float-row mb-3" },
                React.createElement("span", { className: "text-muted float-start" },
                    ...
                    " seconds)"),
                "\u00A0",
                React.createElement("span", { className: "text-muted float-end" },
                    React.createElement("a", { href: "#bonuses" }, "Jump to bonuses")))
            : React.createElement("div", { className: "text-muted" }, "No tossups found"),
        React.createElement("div", null, tossupCards),
        tossupPaginationLength > 1 &&
            React.createElement("nav", { "aria-label": "tossup nagivation" },
                React.createElement("ul", { className: "pagination justify-content-center" },
                    React.createElement("li", { className: "page-item" },
                        React.createElement("a", { className: "page-link", href: "#", "aria-label": "First", onClick: event => { handleTossupPaginationClick(event, 'first'); } }, "\u00AB")),
                    React.createElement("li", { className: "page-item" },
                        React.createElement("a", { className: "page-link", href: "#", "aria-label": "Previous", onClick: event => { handleTossupPaginationClick(event, 'previous'); } }, "\u2039")),
                    arrayBetween(Math.min(tossupPaginationShift), Math.min(tossupPaginationShift + paginationShiftLength, tossupPaginationLength)).map((i) => {
                        ...
                        return React.createElement("li", { key: `tossup-pagination-${i + 1}`, className: "page-item" },
                            React.createElement("a", { className: `page-link ${isActive && 'active'}`, href: "#", onClick: event => { handleTossupPaginationClick(event, i + 1); } }, i + 1));
                    }),
                    React.createElement("li", { className: "page-item" },
                        React.createElement("a", { className: "page-link", href: "#", "aria-label": "Next", onClick: event => { handleTossupPaginationClick(event, 'next'); } }, "\u203A")),
                    React.createElement("li", { className: "page-item" },
                        React.createElement("a", { className: "page-link", href: "#", "aria-label": "Last", onClick: event => { handleTossupPaginationClick(event, 'last'); } },
        ...
        bonusCount > 0
            ? React.createElement("div", { className: "float-row mb-3" },
                ...
                "\u00A0",
                React.createElement("span", { className: "text-muted float-end" },
                    React.createElement("a", { href: "#tossups" }, "Jump to tossups")))
            : React.createElement("div", { className: "text-muted" }, "No bonuses found"),
        React.createElement("div", null, bonusCards),
        bonusPaginationLength > 1 &&
            React.createElement("nav", { "aria-label": "bonus nagivation" },
                React.createElement("ul", { className: "pagination justify-content-center" },
                    React.createElement("li", { className: "page-item" },
                        React.createElement("a", { className: "page-link", href: "#", "aria-label": "First", onClick: event => { handleBonusPaginationClick(event, 'first'); } }, "\u00AB")),
                    React.createElement("li", { className: "page-item" },
                        React.createElement("a", { className: "page-link", href: "#", "aria-label": "Previous", onClick: event => { handleBonusPaginationClick(event, 'previous'); } }, "\u2039")),
                    arrayBetween(Math.min(bonusPaginationShift), Math.min(bonusPaginationShift + paginationShiftLength, bonusPaginationLength)).map((i) => {
                        ...
                        return React.createElement("li", { key: `bonus-pagination-${i + 1}`, className: "page-item" },
                            React.createElement("a", { className: `page-link ${isActive && 'active'}`, href: "#", onClick: event => { handleBonusPaginationClick(event, i + 1); } }, i + 1));
                    }),
                    React.createElement("li", { className: "page-item" },
                        React.createElement("a", { className: "page-link", href: "#", "aria-label": "Next", onClick: event => { handleBonusPaginationClick(event, 'next'); } }, "\u203A")),
                    React.createElement("li", { className: "page-item" },
                        React.createElement("a", { className: "page-link", href: "#", "aria-label": "Last", onClick: event => { handleBonusPaginationClick(event, 'last'); } },
                            React.createElement("span", { "aria-hidden": "true" }, "\u00BB"))))),
        React.createElement("div", { className: "mb-5" })));
}
